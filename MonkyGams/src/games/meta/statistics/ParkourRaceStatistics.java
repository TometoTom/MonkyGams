...
public class ParkourRaceStatistics extends GameStatistics {
	
	public int deaths = 0;
	public HashMap<String, Long> personalBests = new HashMap<>();
	
	public ParkourRaceStatistics(GameType gt, long timePlayed, int gamesPlayed, int wins, int deaths, HashMap<String, Long> personalBests) {
